...
#ifndef COMPONENTS_AD_BLOCKER_IOS_ADBLOCK_CONTENT_RULE_LIST_PROVIDER_H_
#define COMPONENTS_AD_BLOCKER_IOS_ADBLOCK_CONTENT_RULE_LIST_PROVIDER_H_
...
class AdBlockerContentRuleListProvider {
 public:
  ...
  virtual void InstallContentRuleLists(const base::ListValue& lists) = 0;
...
#endif  // COMPONENTS_AD_BLOCKER_IOS_ADBLOCK_CONTENT_RULE_LIST_PROVIDER_H_
