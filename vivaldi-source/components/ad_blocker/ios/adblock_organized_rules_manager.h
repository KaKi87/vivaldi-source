...
#ifndef COMPONENTS_AD_BLOCKER_IOS_ADBLOCK_ORGANIZED_RULES_MANAGER_H_
#define COMPONENTS_AD_BLOCKER_IOS_ADBLOCK_ORGANIZED_RULES_MANAGER_H_
...
#endif  // COMPONENTS_AD_BLOCKER_IOS_ADBLOCK_ORGANIZED_RULES_MANAGER_H_
