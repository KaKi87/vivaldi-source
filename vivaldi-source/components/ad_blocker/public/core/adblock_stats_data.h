...
#ifndef COMPONENTS_AD_BLOCKER_PUBLIC_CORE_ADBLOCK_STATS_DATA_H_
#define COMPONENTS_AD_BLOCKER_PUBLIC_CORE_ADBLOCK_STATS_DATA_H_
...
#endif  // COMPONENTS_AD_BLOCKER_PUBLIC_CORE_ADBLOCK_STATS_DATA_H_
