...
#ifndef COMPONENTS_AD_BLOCKER_PUBLIC_CORE_ADBLOCK_STATS_STORE_H_
#define COMPONENTS_AD_BLOCKER_PUBLIC_CORE_ADBLOCK_STATS_STORE_H_
...
#endif  // COMPONENTS_AD_BLOCKER_PUBLIC_CORE_ADBLOCK_STATS_STORE_H_
