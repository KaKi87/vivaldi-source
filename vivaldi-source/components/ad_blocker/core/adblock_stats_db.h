...
#ifndef COMPONENTS_AD_BLOCKER_CORE_ADBLOCK_STATS_DB_H_
#define COMPONENTS_AD_BLOCKER_CORE_ADBLOCK_STATS_DB_H_
...
#endif  // COMPONENTS_AD_BLOCKER_CORE_ADBLOCK_STATS_DB_H_
