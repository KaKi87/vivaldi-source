...
#ifndef COMPONENTS_REQUEST_FILTER_IMPL_ADBLOCK_FILTER_ADBLOCK_RESOURCES_H_
#define COMPONENTS_REQUEST_FILTER_IMPL_ADBLOCK_FILTER_ADBLOCK_RESOURCES_H_
...
#endif  // COMPONENTS_REQUEST_FILTER_IMPL_ADBLOCK_FILTER_ADBLOCK_RESOURCES_H_
