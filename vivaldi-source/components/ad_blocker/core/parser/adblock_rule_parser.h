...
#ifndef COMPONENTS_AD_BLOCKER_CORE_PARSER_ADBLOCK_RULE_PARSER_H_
#define COMPONENTS_AD_BLOCKER_CORE_PARSER_ADBLOCK_RULE_PARSER_H_
...
#endif  // COMPONENTS_AD_BLOCKER_CORE_ADBLOCK_RULE_PARSER_H_
