...
TEST(AdBlockRuleParserTest, NothingParsed) {
  ...
  EXPECT_EQ(ParsedMetadata{}, parse_result.metadata);
...
TEST(AdBlockRuleParserTest, BadFilter) {
  ParseResult parse_result;
  RuleParser rule_parser(&parse_result, {});

  std::vector<RequestFilterRule> expected_rules;

  EXPECT_EQ(RuleParser::kError, rule_parser.Parse("pattern$~badfilter"));
  EXPECT_EQ(RuleParser::kError, rule_parser.Parse("pattern$badfilter=x"));

  EXPECT_EQ(RuleParser::kRequestFilterRule,
            rule_parser.Parse("badword$badfilter"));
  expected_rules.emplace_back();
  expected_rules.back().original_rule_text = "badword$badfilter";
  expected_rules.back().pattern = "badword";
  expected_rules.back().resource_types.PutAll(RegularResourceTypes::All());
  expected_rules.back().bad_filter = true;

  EXPECT_EQ(RuleParser::kRequestFilterRule,
            rule_parser.Parse("||a.bad.domain.com^$badfilter"));
  expected_rules.emplace_back();
  expected_rules.back().original_rule_text = "||a.bad.domain.com^$badfilter";
  expected_rules.back().resource_types.PutAll(RegularResourceTypes::All());
  expected_rules.back().explicit_types.Put(ResourceType::kDocument);
  ...
  EXPECT_EQ(RuleParser::kRequestFilterRule,
            rule_parser.Parse("tracker.jpg$image,badfilter"));
  expected_rules.emplace_back();
  expected_rules.back().original_rule_text = "tracker.jpg$image,badfilter";
...
TEST(AdBlockRuleParserTest, OptionsParsing) {
  ...
  expected_rules.back().modifier = ModifierType::kCsp;
...
TEST(AdBlockRuleParserTest, HostAnchorsAndStrictBlocking) {
  ...
  expected_rules.back().explicit_types.Put(ResourceType::kPopup);
  expected_rules.back().anchor_type.set(RequestFilterRule::kAnchorHost);
  ...
  expected_rules.back().decision = RuleDecision::kPass;
  expected_rules.back().resource_types.PutAll(RegularResourceTypes::All());
...
TEST(AdBlockRuleParserTest, RequestMethod) {
  ParseResult parse_result;
  RuleParser rule_parser(&parse_result, {});

  std::vector<RequestFilterRule> expected_rules;

  EXPECT_EQ(RuleParser::kError, rule_parser.Parse("not-methods$~method=put"));

  EXPECT_EQ(RuleParser::kRequestFilterRule,
            rule_parser.Parse("specific-method$method=get"));
  expected_rules.emplace_back();
  expected_rules.back().original_rule_text = "specific-method$method=get";
  expected_rules.back().request_methods.Clear();
  expected_rules.back().request_methods.Put(RequestMethod::kGet);
  expected_rules.back().resource_types.PutAll(RegularResourceTypes::All());
  expected_rules.back().pattern = "specific-method";

  EXPECT_EQ(RuleParser::kRequestFilterRule,
            rule_parser.Parse("mulitple-method$method=get|post"));
  expected_rules.emplace_back();
  expected_rules.back().original_rule_text = "mulitple-method$method=get|post";
  expected_rules.back().request_methods.Clear();
  expected_rules.back().request_methods.Put(RequestMethod::kGet);
  expected_rules.back().request_methods.Put(RequestMethod::kPost);
  expected_rules.back().resource_types.PutAll(RegularResourceTypes::All());
  expected_rules.back().pattern = "mulitple-method";

  EXPECT_EQ(RuleParser::kRequestFilterRule,
            rule_parser.Parse("except-method$method=~put"));
  expected_rules.emplace_back();
  expected_rules.back().original_rule_text = "except-method$method=~put";
  expected_rules.back().request_methods.Remove(RequestMethod::kPut);
  expected_rules.back().resource_types.PutAll(RegularResourceTypes::All());
  expected_rules.back().pattern = "except-method";

  EXPECT_EQ(RuleParser::kRequestFilterRule,
            rule_parser.Parse("except-multiple-method$method=~put|~patch"));
  expected_rules.emplace_back();
  expected_rules.back().original_rule_text =
      "except-multiple-method$method=~put|~patch";
  expected_rules.back().request_methods.Remove(RequestMethod::kPut);
  expected_rules.back().request_methods.Remove(RequestMethod::kPatch);
  expected_rules.back().resource_types.PutAll(RegularResourceTypes::All());
  expected_rules.back().pattern = "except-multiple-method";

  EXPECT_EQ(RuleParser::kRequestFilterRule,
            rule_parser.Parse("mixed-method$method=get|~put|~patch|connect"));
  expected_rules.emplace_back();
  expected_rules.back().original_rule_text =
      "mixed-method$method=get|~put|~patch|connect";
  expected_rules.back().request_methods.Remove(RequestMethod::kPut);
  expected_rules.back().request_methods.Remove(RequestMethod::kPatch);
  expected_rules.back().resource_types.PutAll(RegularResourceTypes::All());
  expected_rules.back().pattern = "mixed-method";
...
TEST(AdBlockRuleParserTest, ResourceTypes) {
  ...
  expected_rules.back().resource_types.Put(ResourceType::kImage);
  expected_rules.back().resource_types.Put(ResourceType::kMedia);
  expected_rules.back().resource_types.Put(ResourceType::kFont);
  ...
  expected_rules.back().resource_types.PutAll(RegularResourceTypes::All());
  expected_rules.back().resource_types.Remove(ResourceType::kScript);
  expected_rules.back().resource_types.Remove(ResourceType::kStylesheet);
  ...
  expected_rules.back().resource_types.PutAll(RegularResourceTypes::All());
  expected_rules.back().resource_types.Remove(ResourceType::kImage);
  expected_rules.back().resource_types.Remove(ResourceType::kMedia);
...
TEST(AdBlockRuleParserTest, Parties) {
  ...
  EXPECT_EQ(RuleParser::kError,
            rule_parser.Parse("bad-resource$strict1p=invalid"));
  EXPECT_EQ(RuleParser::kError, rule_parser.Parse("bad-resource$~strict1p"));
  EXPECT_EQ(RuleParser::kError, rule_parser.Parse("bad-resource$strict1p,3p"));
  ...
  expected_rules.back().resource_types.PutAll(RegularResourceTypes::All());
  expected_rules.back().party = Party::kThird;
  expected_rules.back().pattern = "bad-resource";
  ...
  expected_rules.back().original_rule_text = "bad-resource$~third-party";
  expected_rules.back().resource_types.PutAll(RegularResourceTypes::All());
  expected_rules.back().party = Party::kFirst;
  expected_rules.back().pattern = "bad-resource";
  ...
  EXPECT_EQ(RuleParser::kRequestFilterRule,
            rule_parser.Parse("bad-resource$strict1p"));
  expected_rules.emplace_back();
  expected_rules.back().original_rule_text = "bad-resource$strict1p";
  expected_rules.back().party = Party::kStrictFirst;
  expected_rules.back().resource_types.PutAll(RegularResourceTypes::All());
  expected_rules.back().pattern = "bad-resource";

  EXPECT_EQ(RuleParser::kRequestFilterRule,
            rule_parser.Parse("bad-resource$strict3p"));
  expected_rules.emplace_back();
  expected_rules.back().original_rule_text = "bad-resource$strict3p";
  expected_rules.back().party = Party::kStrictThird;
  expected_rules.back().resource_types.PutAll(RegularResourceTypes::All());
  expected_rules.back().pattern = "bad-resource";

  EXPECT_EQ(RuleParser::kRequestFilterRule,
            rule_parser.Parse("bad-resource$strict1p,1p"));
  expected_rules.emplace_back();
  expected_rules.back().original_rule_text = "bad-resource$strict1p,1p";
  expected_rules.back().party = Party::kStrictFirst;
  expected_rules.back().resource_types.PutAll(RegularResourceTypes::All());
  expected_rules.back().pattern = "bad-resource";

  EXPECT_EQ(RuleParser::kRequestFilterRule,
            rule_parser.Parse("bad-resource$strict3p,3p"));
  expected_rules.emplace_back();
  expected_rules.back().original_rule_text = "bad-resource$strict3p,3p";
  expected_rules.back().party = Party::kStrictThird;
  expected_rules.back().resource_types.PutAll(RegularResourceTypes::All());
  expected_rules.back().pattern = "bad-resource";

  EXPECT_EQ(RuleParser::kRequestFilterRule,
            rule_parser.Parse("bad-resource$strict3p,1p"));
  expected_rules.emplace_back();
  expected_rules.back().original_rule_text = "bad-resource$strict3p,1p";
  expected_rules.back().party = Party::kFirstAndStrictThird;
  expected_rules.back().resource_types.PutAll(RegularResourceTypes::All());
  expected_rules.back().pattern = "bad-resource";

  EXPECT_EQ(RuleParser::kRequestFilterRule,
            rule_parser.Parse("bad-resource$strict3p,strict1p"));
  expected_rules.emplace_back();
  expected_rules.back().original_rule_text = "bad-resource$strict3p,strict1p";
  expected_rules.back().resource_types.PutAll(RegularResourceTypes::All());
  expected_rules.back().pattern = "bad-resource";

  EXPECT_EQ(RuleParser::kRequestFilterRule,
            rule_parser.Parse("bad-resource$strict3p,strict1p,strict1p"));
  expected_rules.emplace_back();
  expected_rules.back().original_rule_text =
      "bad-resource$strict3p,strict1p,strict1p";
  expected_rules.back().party = Party::kStrictFirst;
  expected_rules.back().resource_types.PutAll(RegularResourceTypes::All());
  expected_rules.back().pattern = "bad-resource";
...
TEST(AdBlockRuleParserTest, AllowRuleAndActivation) {
  ...
  expected_rules.back().decision = RuleDecision::kPass;
  expected_rules.back().explicit_types.Put(ResourceType::kDocument);
  expected_rules.back().activation_types.Put(ActivationType::kWholeDocument);
  expected_rules.back().anchor_type.set(RequestFilterRule::kAnchorStart);
  ...
  expected_rules.back().decision = RuleDecision::kPass;
  expected_rules.back().modify_block = false;
  expected_rules.back().activation_types.Put(ActivationType::kGenericBlock);
  expected_rules.back().activation_types.Put(ActivationType::kGenericHide);

  expected_rules.back().pattern = "good-resource";

  EXPECT_EQ(RuleParser::kRequestFilterRule,
            rule_parser.Parse("@@no-hiding$elemhide"));
  expected_rules.emplace_back();
  expected_rules.back().original_rule_text = "@@no-hiding$elemhide";
  expected_rules.back().decision = RuleDecision::kPass;
  expected_rules.back().modify_block = false;
  expected_rules.back().activation_types.Put(ActivationType::kSpecificHide);
  expected_rules.back().activation_types.Put(ActivationType::kGenericHide);

  expected_rules.back().pattern = "no-hiding";
  ...
  expected_rules.back().decision = RuleDecision::kModify;
  expected_rules.back().modify_block = false;
  expected_rules.back().activation_types.Put(ActivationType::kGenericBlock);
  ...
  expected_rules.back().decision = RuleDecision::kModifyImportant;
  expected_rules.back().modify_block = false;
  expected_rules.back().activation_types.Put(ActivationType::kGenericBlock);
