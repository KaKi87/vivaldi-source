...
#ifndef COMPONENTS_AD_BLOCKER_CORE_PARSER_ADBLOCK_RULESET_FILE_PARSER_H_
#define COMPONENTS_AD_BLOCKER_CORE_PARSER_ADBLOCK_RULESET_FILE_PARSER_H_
...
#endif  // COMPONENTS_AD_BLOCKER_CORE_PARSER_ADBLOCK_RULESET_FILE_PARSER_H_
