...
#ifndef COMPONENTS_AD_BLOCKER_CORE_PARSER_ADBLOCK_REQUEST_FILTER_RULE_H_
#define COMPONENTS_AD_BLOCKER_CORE_PARSER_ADBLOCK_REQUEST_FILTER_RULE_H_
...
#endif  // COMPONENTS_AD_BLOCKER_CORE_PARSER_ADBLOCK_REQUEST_FILTER_RULE_H_
