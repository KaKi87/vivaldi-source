...
#ifndef COMPONENTS_AD_BLOCKER_CONTENT_ADBLOCK_RULE_PATTERN_MATCHER_H_
#define COMPONENTS_AD_BLOCKER_CONTENT_ADBLOCK_RULE_PATTERN_MATCHER_H_
...
class RulePatternMatcher {
 public:
  ...
  //
  // |must_intersect_host| is used by popunder blocking, to block popunders
  // that match a popup filter, only if the pattern hits at least some
  // characters between the beginning and the end of the hostname.
  bool MatchesUrl(const UrlInfo& url, bool must_intersect_host) const;
...
#endif  // COMPONENTS_AD_BLOCKER_CONTENT_ADBLOCK_RULE_PATTERN_MATCHER_H_
