...
#ifndef COMPONENTS_AD_BLOCKER_CONTENT_ADBLOCK_RULES_INDEX_BUILDER_H_
#define COMPONENTS_AD_BLOCKER_CONTENT_ADBLOCK_RULES_INDEX_BUILDER_H_
...
#endif  // COMPONENTS_AD_BLOCKER_CONTENT_ADBLOCK_RULES_INDEX_BUILDER_H_
