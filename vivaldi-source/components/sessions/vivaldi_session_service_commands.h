...
CreateSetWindowVivExtDataCommand(SessionID::id_type command_id,
                                 SessionID window_id,
                                 const std::string& viv_ext_data);
...
// for a specific tab
SESSIONS_EXPORT std::unique_ptr<SessionCommand>
CreateVivPageActionOverrideCommand(SessionID::id_type command_id,
                                   SessionID tab_id,
...
SESSIONS_EXPORT std::unique_ptr<SessionCommand>
CreateSetWindowVivExtDataCommand(const SessionID& window_id,
                                 const std::string& viv_ext_data);
...
SESSIONS_EXPORT std::unique_ptr<SessionCommand>
CreateVivPageActionOverrideCommand(const SessionID& tab_id,
                                   const std::string& script_path,
                                   bool is_enabled_override);
...
SESSIONS_EXPORT std::unique_ptr<SessionCommand> CreateVivCreateThumbnailCommand(
    int image_format,
    const char* data,
    size_t size);
