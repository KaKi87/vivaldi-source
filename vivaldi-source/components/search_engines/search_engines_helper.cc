...
SearchEngineType StringToSearchEngine(const std::string& s) {
  constexpr auto search_engine_types_map =
      base::MakeFixedFlatMap<std::string_view, SearchEngineType>({
          ...
          {"SEARCH_ENGINE_YOU", SEARCH_ENGINE_YOU},
          {"SEARCH_ENGINE_STARTER_PACK_GEMINI",
           SEARCH_ENGINE_STARTER_PACK_GEMINI},
          {"SEARCH_ENGINE_LILO", SEARCH_ENGINE_LILO},
          {"SEARCH_ENGINE_STARTPAGE", SEARCH_ENGINE_STARTPAGE},
          {"SEARCH_ENGINE_STARTER_PACK_PAGE", SEARCH_ENGINE_STARTER_PACK_PAGE},
          {"SEARCH_ENGINE_MCAFEE", SEARCH_ENGINE_MCAFEE},
          {"SEARCH_ENGINE_FREESPOKE", SEARCH_ENGINE_FREESPOKE},
          {"SEARCH_ENGINE_KAGI", SEARCH_ENGINE_KAGI},
          {"SEARCH_ENGINE_STARTER_PACK_AI_MODE",
           SEARCH_ENGINE_STARTER_PACK_AI_MODE},
          {"SEARCH_ENGINE_YAHOO_JP", SEARCH_ENGINE_YAHOO_JP},
  ...
  static_assert(search_engine_types_map.size() ==
                    static_cast<size_t>(SearchEngineType::SEARCH_ENGINE_MAX),
                "StringToSearchEngine size missmatch. Add missing type to "
                "string translations.");
...
std::optional<RegulatoryExtensionType> StringToRegulatoryExtensionType(
    const std::string& s) {
  constexpr auto regulatory_extension_types_map =
      base::MakeFixedFlatMap<std::string_view, RegulatoryExtensionType>({
  ...
  static_assert(
      regulatory_extension_types_map.size() ==
          static_cast<size_t>(RegulatoryExtensionType::kMaxValue) + 1,
      "StringToRegulatoryExtensionType size missmatch. Add missing type to "
      "string translations.");
