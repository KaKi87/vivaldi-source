      ...
      profile_(Profile::FromWebUI(web_ui))
{
  ...
  static constexpr webui::LocalizedString localized_strings[] = {
      ...
      {"contextButtonEditText", IDS_PROFILE_PICKER_EDIT},
      {"contextButtonText", IDS_PROFILE_MORE_ACTIONS},
      {"contextButtonDeleteText", IDS_PROFILE_DELETE},
      {"contextButtonDeleteLongText", IDS_PROFILE_DELETE_LONG},
      {"selectCustomAvatar", IDS_PROFILE_SELECT_CUSTOM_AVATAR},
      {"confirmationText", IDS_PROFILE_CONFIRM_DELETE_PROFILE},
      {"cancelButtonText", IDS_PROFILE_CANCEL_BUTTON},
      {"saveButtonText", IDS_PROFILE_SAVE_BUTTON},
  };
