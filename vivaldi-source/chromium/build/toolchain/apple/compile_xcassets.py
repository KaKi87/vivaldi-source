  ...
  """
    ...
    for relative_path in inputs:
        ...
        for file_or_dir_name in os.listdir(relative_path):
            ...
            if asset_type == ".icon":
                # need to check this because vivaldi has multiple icons
                # chromium has only one and therefore inputs.remove works
                # for them
                if relative_path in inputs:
                ...
                command.extend(['--app-icon', asset_name])
                # Vivaldi: Enable fallback generation for icon stacks to
                # ensure that both iOS 26 and below has same icons.
                # command.extend(
