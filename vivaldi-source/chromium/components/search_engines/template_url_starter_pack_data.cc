...
const StarterPackEngine bookmarks = {
    ...
    .favicon_url = nullptr,
    .search_url = "vivaldi://bookmarks/?q={searchTerms}",
    .destination_url = "vivaldi://bookmarks",
...
const StarterPackEngine history = {
    ...
    .favicon_url = nullptr,
    .search_url = "vivaldi://history/?q={searchTerms}",
    .destination_url = "vivaldi://history",
...
const StarterPackEngine tabs = {
    ...
    // vivaldi://tabs does not currently exist and the tab search engine will
    // only provide suggestions from the OpenTabProvider.
    .search_url = "vivaldi://tabs/?q={searchTerms}",
    .destination_url = "https://help.vivaldi.com/desktop/tabs/window-panel/",
