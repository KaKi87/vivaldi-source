...
class TemplateUrlServiceAndroid : public TemplateURLServiceObserver {
 public:
  ...
  base::android::ScopedJavaLocalRef<jobject> VivaldiGetSearchEngineForHost(
      JNIEnv* env,
      const base::android::JavaRef<jobject>& obj,
      const base::android::JavaRef<jstring>& jhost
    );
  ...
  void AddCustomSearchEngine(
      JNIEnv* env,
      const base::android::JavaRef<jobject>& obj,
      const base::android::JavaRef<jstring>& short_name,
      const base::android::JavaRef<jstring>& nickname,
      const base::android::JavaRef<jstring>& searchable_jurl,
      const base::android::JavaRef<jstring>& suggest_jurl,
      const base::android::JavaRef<jstring>& jsearch_url_post_params,
      const base::android::JavaRef<jstring>& jimage_url,
      const base::android::JavaRef<jstring>& jimage_url_post_params);
  ...
  jboolean UpdateTemplateUrl(
      ...
      const base::android::JavaRef<jobject>& obj,
      const base::android::JavaRef<jstring>& jkeyword,
      const base::android::JavaRef<jstring>& jnew_keyword,
      const base::android::JavaRef<jstring>& jshort_name,
      const base::android::JavaRef<jstring>& searchable_jurl,
      const base::android::JavaRef<jstring>& suggestion_jurl,
      const base::android::JavaRef<jstring>& jsearch_url_post_params,
      const base::android::JavaRef<jstring>& jimage_url,
      const base::android::JavaRef<jstring>& jimage_url_post_params);
