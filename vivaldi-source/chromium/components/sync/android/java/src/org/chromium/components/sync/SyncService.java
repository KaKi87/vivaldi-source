...
public interface SyncService {
    ...
    // Vivaldi - Below legacy Sync methods are removed since Chromium 150. We are patching it here
    // to stop Sync from starting on Vivaldi until the user actively consents it.
