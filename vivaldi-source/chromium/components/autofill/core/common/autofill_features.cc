...
BASE_FEATURE(kAutofillAiAvailableByDefault, base::FEATURE_DISABLED_BY_DEFAULT);  // Vivaldi keep disabled
...
BASE_FEATURE(kAutofillAiDedupeEntities, base::FEATURE_DISABLED_BY_DEFAULT);  // Vivaldi keep disabled
             // IS_AUTOFILL_AI_PLATFORM ? base::FEATURE_ENABLED_BY_DEFAULT
             //                        : base::FEATURE_DISABLED_BY_DEFAULT);
...
BASE_FEATURE(kAutofillAiReauthRequired, base::FEATURE_DISABLED_BY_DEFAULT);  // Vivaldi keep disabled
             // IS_AUTOFILL_AI_PLATFORM ? base::FEATURE_ENABLED_BY_DEFAULT
             //                         : base::FEATURE_DISABLED_BY_DEFAULT);
...
// predictions.
BASE_FEATURE(kAutofillAiServerModel, base::FEATURE_DISABLED_BY_DEFAULT);  // Vivaldi keep disabled
             // IS_AUTOFILL_AI_PLATFORM ? base::FEATURE_ENABLED_BY_DEFAULT
             //                         : base::FEATURE_DISABLED_BY_DEFAULT);
...
BASE_FEATURE(kAutofillAiUsePrivateAi, base::FEATURE_DISABLED_BY_DEFAULT); // Vivaldi keep disabled
...
BASE_FEATURE(kAutofillAiVoteForFormatStringsForFlightNumbers, base::FEATURE_DISABLED_BY_DEFAULT);  // Vivaldi keep disabled
             // IS_AUTOFILL_AI_PLATFORM ? base::FEATURE_ENABLED_BY_DEFAULT
             //                        : base::FEATURE_DISABLED_BY_DEFAULT);

// If enabled, AutofillAi supports flight reservation entities from Google
// Wallet.
BASE_FEATURE(kAutofillAiWalletFlightReservation, base::FEATURE_DISABLED_BY_DEFAULT);  // Vivaldi keep disabled
             // IS_AUTOFILL_AI_PLATFORM ? base::FEATURE_ENABLED_BY_DEFAULT
             //                         : base::FEATURE_DISABLED_BY_DEFAULT);
...
// Wallet.
BASE_FEATURE(kAutofillAiWalletVehicleRegistration, base::FEATURE_DISABLED_BY_DEFAULT);  // Vivaldi keep disabled
             // IS_AUTOFILL_AI_PLATFORM ? base::FEATURE_ENABLED_BY_DEFAULT
             //                        : base::FEATURE_DISABLED_BY_DEFAULT);

// Enables the second iteration AutofillAI.
BASE_FEATURE(kAutofillAiWithDataSchema, base::FEATURE_DISABLED_BY_DEFAULT);  // Vivaldi keep disabled
             // IS_AUTOFILL_AI_PLATFORM ? base::FEATURE_ENABLED_BY_DEFAULT
             //                         : base::FEATURE_DISABLED_BY_DEFAULT);
