...
void RegisterProfilePrefs(user_prefs::PrefRegistrySyncable* registry) {
  ...
  registry->RegisterIntegerPref(
      ...
      user_prefs::PrefRegistrySyncable::SYNCABLE_PREF);
  registry->RegisterBooleanPref(
      kAutofillAiIdentityEntitiesEnabled, false, // Vivaldi keep disabled
      user_prefs::PrefRegistrySyncable::SYNCABLE_PREF);
  registry->RegisterBooleanPref(
      kAutofillAiShoppingEntitiesEnabled, false, // Vivaldi keep disabled
      user_prefs::PrefRegistrySyncable::SYNCABLE_PREF);
  registry->RegisterIntegerPref(
      kAutofillAiLastVersionDeduped, 0,
      user_prefs::PrefRegistrySyncable::SYNCABLE_PREF);
  registry->RegisterBooleanPref(
      kAutofillAiPrivateInferenceOptInStatus, false,  // Vivaldi keep disabled
      user_prefs::PrefRegistrySyncable::SYNCABLE_PREF);
  registry->RegisterBooleanPref(
      kAutofillAiTravelEntitiesEnabled, false,  // Vivaldi keep disabled
      user_prefs::PrefRegistrySyncable::SYNCABLE_PREF);
