...
const char kOldQueryHistoryUrl[] =
    KNOWN_404("/apis/history/api/lookup?client=chrome");
const char kNewQueryHistoryUrl[] =
    KNOWN_404("/apis/v1/read_chrome_history");

const char kOldHistoryDeleteHistoryUrl[] =
    KNOWN_404("/apis/history/api/delete?client=chrome");
const char kNewHistoryDeleteHistoryUrl[] =
    KNOWN_404("/apis/v1/delete_chrome_history");

const char kOldQueryWebAndAppActivityUrl[] =
    KNOWN_404("/apis/history/api/lookup?client=web_app");
const char kNewQueryWebAndAppActivityUrl[] =
    KNOWN_404("/apis/v1/get_facs");
