...
public interface BackPressHandler {
    ...
    @interface Type {
        ...
        // Vivaldi VAB-13076: Handlers are dispatched in ascending value order, so this must run
        // before MINIMIZE_APP_AND_CLOSE_TAB (always enabled on Android 12 and earlier)
        // for double-tap-to-exit to consume the final back press.
        int VIVALDI_DOUBLE_BACK_PRESS = 23;
