...
// Creates a UIAction instance whose title and icon are configured for
// add folder which will invoke the given edit |block| when executed.
...
// Creates a UIAction instance whose title and icon are configured for clear
// history - which will invoke the given edit |block| when executed.
