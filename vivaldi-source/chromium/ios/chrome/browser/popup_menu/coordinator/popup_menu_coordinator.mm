...
- (void)showToolsMenuPopup {
  ...
  if (IsVivaldiRunning()) {
    UIView* toolsMenuButton =
        [layoutGuideCenter referencedViewUnderName:vToolsMenuGuide];
    if (!toolsMenuButton) {
      toolsMenuButton =
    ...
    if (toolsMenuButton) {
      popoverPresentationController.sourceView = toolsMenuButton;
      popoverPresentationController.sourceRect = toolsMenuButton.bounds;
    } else {
