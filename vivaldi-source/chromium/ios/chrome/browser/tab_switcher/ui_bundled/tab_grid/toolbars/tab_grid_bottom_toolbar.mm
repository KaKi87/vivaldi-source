...
- (void)setupViews {
  ...
  if (IsVivaldiRunning()) {
    [_containerToolbar setShadowImage:
        [[UIImage alloc] init] forToolbarPosition:UIBarPositionAny];
    _containerToolbar.overrideUserInterfaceStyle =
        UIUserInterfaceStyleUnspecified;
    _containerToolbar.barStyle = UIBarStyleDefault;
  }
  // End Vivaldi
