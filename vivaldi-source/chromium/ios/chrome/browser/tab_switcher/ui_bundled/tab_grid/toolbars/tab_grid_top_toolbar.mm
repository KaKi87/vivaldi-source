...
- (void)setUpConstraintsForContainerView:(UIView*)containerView {
  ...
  if (vivaldi::IsVivaldiRunning()) {
    ...
    _selectedTabsLabel.tintColor = [UIColor colorNamed:vTabGridToolbarTextButtonColor];
    _selectedTabsLabel.textColor = [UIColor colorNamed:vTabGridToolbarTextButtonColor];
    _selectedTabsLabel.font = [[UIFontMetrics metricsForTextStyle:UIFontTextStyleBody]
                  scaledFontForFont:[UIFont systemFontOfSize:kSelectionFontSize
                             weight:UIFontWeightSemibold]];
