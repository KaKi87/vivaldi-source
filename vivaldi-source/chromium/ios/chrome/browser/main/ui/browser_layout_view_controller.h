...
// Vivaldi
// Returns the current tab strip height, including Vivaldi's dynamic two-level
// stacks height when applicable.
- (CGFloat)currentTabStripHeight;

// Recomputes the tab strip layout for Vivaldi-specific states such as phone
// tab strip visibility, bottom omnibox positioning, and background color.
- (void)updateVivaldiTabStripLayout;

// Updates the tab strip alpha during fullscreen transitions.
