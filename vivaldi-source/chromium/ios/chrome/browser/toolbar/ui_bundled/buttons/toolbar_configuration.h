...
#ifndef IOS_CHROME_BROWSER_TOOLBAR_UI_BUNDLED_BUTTONS_TOOLBAR_CONFIGURATION_H_
#define IOS_CHROME_BROWSER_TOOLBAR_UI_BUNDLED_BUTTONS_TOOLBAR_CONFIGURATION_H_
...
#endif  // IOS_CHROME_BROWSER_TOOLBAR_UI_BUNDLED_BUTTONS_TOOLBAR_CONFIGURATION_H_
