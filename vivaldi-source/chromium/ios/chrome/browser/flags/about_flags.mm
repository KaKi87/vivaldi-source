...
#import "ios/chrome/browser/features/vivaldi_ios_chrome_flag_descriptions.h"
// End Vivaldi
...
const flags_ui::FeatureEntry kFeatureEntries[] = {
  ...
  // Vivaldi
    {"vivaldi-show-top-sites", flag_descriptions::kShowTopSites,
     flag_descriptions::kShowTopSitesDescription, flags_ui::kOsIos,
     FEATURE_VALUE_TYPE(kShowTopSites)},
    {"vivaldi-view_markdown-as-html", flag_descriptions::kViewMarkdownAsHTMLName,
     flag_descriptions::kkViewMarkdownAsHTMLDescription, flags_ui::kOsIos,
     FEATURE_VALUE_TYPE(kViewMarkdownAsHTML)},
    {"vivaldi-show-new-sd-dialog-", flag_descriptions::kShowNewSpeedDialDialog,
     flag_descriptions::kShowNewSpeedDialDialogDescription, flags_ui::kOsIos,
     FEATURE_VALUE_TYPE(kShowNewSpeedDialDialog)},
  // End Vivaldi
