...
class InstallerConfig:
    ...
    def from_args(cls, args: argparse.Namespace,
        ...
        if hasattr(args, "sysroot"):
            ...
            ) = cls._compute_deb_repoconfig(args.arch, data["package_orig"], data["channel"])
        else:
            # RPM specific
            (
                data["repoconfig"],
    ...
    @staticmethod
    def _compute_deb_repoconfig(arch: str, package: str, channel: str) -> tuple[str, str]:
        base_repo_config = f"repo.vivaldi.com/{channel}/deb/ stable main"
    ...
    def get_desktop_integration_artifacts(self) -> list[Artifact]:
        ...
        artifacts.append(
            Artifact(
                ...
                f"{self.usr_bin_symlink_name}.desktop",
                ArtifactType.TEMPLATE,
                StandardPermissions.REGULAR,
                dst_base="staging_dir",
            ))
       ...
       #     ))
        ...
        man_page_dst = (
            pathlib.Path("usr/share/xfce4/helpers") /
            f"{self.info_vars['PACKAGE']}.desktop")
        artifacts.append(
            Artifact(
                "installer/common/xfce-helper.template",
                man_page_dst,
                ArtifactType.TEMPLATE,
                StandardPermissions.REGULAR,
                dst_base="staging_dir",
