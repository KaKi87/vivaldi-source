...
def main() -> None:
    ...
    elif args.branding == "vivaldi":
        config.info_vars["INSTALLDIR"] = "/opt/vivaldi/vivaldi-repo"
        config.info_vars["PACKAGE"] = "vivaldi-repo"
    else:
    ...
    with installer.StagingContext(staging_dir, tmp_file_dir):
        ...
        deb_file = output_dir / f"{pkg_name}_{pgp_key_version}_{args.arch}.deb"
