...
public class HubToolbarCoordinator {
    ...
    public HubToolbarCoordinator(
        ...
        if (BuildConfig.IS_VIVALDI) {
            hubActionButton.setVisibility(GONE);
            mActionButtonCoordinator = new VivaldiHubButtonCoordinator(
        ...
        if (BuildConfig.IS_VIVALDI) {
            ...
            mMenuButton = topToolbarView.findViewById(R.id.menu_button_wrapper);
        }
    ...
    // Vivaldi - Dummy HubButtonCoordinator
    private static class VivaldiHubButtonCoordinator extends HubActionButtonCoordinator {
        VivaldiHubButtonCoordinator(Button actionButton,
                                    View containerView,
                                    PaneManager paneManager,
                                    HubColorMixer hubColorMixer){
            super(actionButton, containerView, paneManager, hubColorMixer);
        }
        @Override
