...
#if !BUILDFLAG(IS_CHROMEOS)
  // note(ondrej@vivaldi) VB-113781 - ChromeSigninClient does not exist in the
  // incognito profile. This wouldn't be necessary if WebUI weren't initialized
  // before throttling, where we filter out the related chrome:// pages
  // anyway.
