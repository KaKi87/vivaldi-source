...
void BrowserWindowFeatures::InitPostWindowConstruction(Browser* browser) {
  ...
  } else if (browser_window_) { // Vivaldi
    VivaldiBrowserWindow* window = static_cast<VivaldiBrowserWindow*>(browser_window_);
    focus_manager = window->GetWidget()->GetFocusManager();
    // End Vivaldi
  }
