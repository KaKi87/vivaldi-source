...
@SuppressWarnings({"unused", "UnusedVariable"}) // Vivaldi
@NullMarked
public class GlicActionCoordinator {
    //private final NullableObservableSupplier<PropertyModel> mGlicActionModelSupplier; Vivaldi
    private final Callback<@Nullable PropertyModel> mModelCallback = this::onModelChanged;
    //private final GlicButtonDelegate mToggleGlicCallback; Vivaldi
    private final NullableObservableSupplier<Tab> mTabSupplier;
    private final CurrentTabObserver mCurrentTabObserver;
    //private final GlicButtonStateController mStateController; Vivaldi
    ...
    private final Drawable mDoneDrawable; Vivaldi */
    ...
    public GlicActionCoordinator(
        ...
        //mDefaultDrawable = AppCompatResources.getDrawable(activity, glicIconResId); Vivaldi
        //mFilledDrawable = AppCompatResources.getDrawable(activity, R.drawable.ic_spark_filled_24dp); Vivaldi
    ...
    /* package */ void onStateChanged(
            /*@GlicButtonStateController.ButtonState int state Vivaldi,*/ boolean isPanelOpen) {
        /* Not needed in Vivaldi
