...
class Browser : public TabStripModelObserver,
 ...
 public:
  ...
  // Vivaldi
  bool is_vivaldi() const override { return is_vivaldi_; }
  ...
  content::WebContents* AddNewContentsVivaldi(
      content::WebContents* source,
  ...
  // Overrides WebContentsDelegate::IsWebApp, needed by Vivaldi in
  // WebContentsDelegate::CanDownload().
 ...
 public:
  const CreateParams & create_params() { return create_params_; }
};
