...
// crbug.com/425711450.
  ...
  // return RenderWidgetHostViewBase which does not have a TextInputClient. We
  // also show video content in webviews in mail-views.
...
bool VideoOverlayWindowViews::ControlsHitTestContainsPoint(
  ...
  if (IsPointInVivaldiControl(point)) {
    return true;
  }
...
#if defined(VIVALDI_BUILD)
  UpdateVivaldiControlsBounds(bottom_controls_bounds.y(),
