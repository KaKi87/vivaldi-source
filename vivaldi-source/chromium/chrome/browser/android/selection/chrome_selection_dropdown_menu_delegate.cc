...
#if BUILDFLAG(GOOGLE_CHROME_BRANDING) // Vivalid
...
#else  // BUILDFLAG(GOOGLE_CHROME_BRANDING) // Vivaldi
  bool is_devtools_allowed = true;
#endif  // BUILDFLAG(GOOGLE_CHROME_BRANDING) // Vivaldi
