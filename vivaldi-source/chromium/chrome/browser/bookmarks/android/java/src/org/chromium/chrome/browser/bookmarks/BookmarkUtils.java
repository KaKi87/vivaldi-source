...
public class BookmarkUtils {
    ...
    private static @Nullable BookmarkId addBookmarkAndShowSnackbar(
        ...
        if ( BuildConfig.IS_VIVALDI) { // Vivaldi Ref. VAB-9205
    ...
    // Vivaldi
    public static @Nullable BookmarkId getLastUsedParentPublic(Context context) {
    ...
    public static void addOrEditBookmark(
        ...
        showSaveFlow(activity, bottomSheetController, tab.getProfile(), newBookmarkId, false,
                /*wasBookmarkMoved=*/false, /*isNewBookmark=*/true,
                opener, priceDropNotificationManager);
