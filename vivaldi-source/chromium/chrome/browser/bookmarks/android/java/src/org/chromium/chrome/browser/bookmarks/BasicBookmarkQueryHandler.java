...
public class BasicBookmarkQueryHandler implements BookmarkQueryHandler {
    ...
    public List<BookmarkListEntry> buildBookmarkListForSearch(
        ...
        if (ChromeApplicationImpl.isVivaldi() && mBookmarkModel.getTrashFolderId() != null) {
            List<BookmarkId> trashBookmarksList =
                    mBookmarkModel.getChildIds(mBookmarkModel.getTrashFolderId());
            searchIdList.removeAll(trashBookmarksList);
        } // End Vivaldi
