...
public class BookmarkManagerCoordinator
    ...
    /** Vivaldi **/
    public BookmarkManagerCoordinator(Context context,
            boolean isDialogUi, SnackbarManager snackbarManager,
            Profile profile, BookmarkUiPrefs bookmarkUiPrefs,
            BookmarkOpener bookmarkOpener) {
        this(context, isDialogUi, snackbarManager, profile,
                bookmarkUiPrefs, bookmarkOpener, new BookmarkManagerOpenerImpl(),
    ...
    public boolean isCurrentInsideTrashFolder() {
        if (mBookmarkModel.isBookmarkModelLoaded()) {
            return mBookmarkModel.isInsideTrashFolder(mMediator.getCurrentFolder());
        }
        return false;
    }
