...
// import org.chromium.chrome.browser.glic.GlicInstanceHelper; Not needed in Vivaldi
...
public class ActorControlStateTracker
        implements ActorKeyedService.Observer /*, GlicInstanceHelper.Observer Not in Vivaldi*/  {
    ...
    // private @Nullable GlicInstanceHelper mGlicInstanceHelper; Not needed in Vivaldi
    ...
    public void onTaskStateChanged(@ActorTaskId int taskId, @ActorTaskState int newState) {
        ...
        boolean isNewAssociatedTask =
                (mTrackedTaskId == null
                        /*&& mGlicInstanceHelper != null Not needed in Vivaldi
    ...
    public String getConversationTitle() {
        //return mGlicInstanceHelper != null ? mGlicInstanceHelper.getConversationTitle() : ""; Not needed in Vivaldi
        return "";
    }
    ...
    public @Nullable ActorTask getActiveTaskAssociatedWithCurrentConversation() {
        if (mActorKeyedService == null /*|| mGlicInstanceHelper == null Not needed in Vivaldi */) {
            return null;
        }
        int taskId = 0; //mGlicInstanceHelper.getTaskId(); Not needed in Vivaldi
        if (taskId <= 0) {
            return null;
        }
