...
//import org.chromium.chrome.browser.glic.GlicEnabling; Not needed in Vivaldi
...
public class ActorUiTabController implements UserData {
    ...
    public static @Nullable ActorUiTabController from(@Nullable Tab tab) {
        ...
        //if (!GlicEnabling.isProfileEligible(tab.getProfile())) return null; Not needed in Vivaldi.
