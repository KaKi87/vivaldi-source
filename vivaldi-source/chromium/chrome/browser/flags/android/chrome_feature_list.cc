...
BASE_FEATURE(kNewTabPageCustomizationForMvt,
...
BASE_FEATURE(kAndroidBottomToolbarV2,
...
BASE_FEATURE(kAndroidOpenPdfInlineBackport,
             ...
             base::FEATURE_DISABLED_BY_DEFAULT); // VAB-11435
...
BASE_FEATURE(kMediaIndicatorsAndroid,
