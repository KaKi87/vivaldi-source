...
// go/keep-sorted start
    ...
    &kEnableToolbarSwipeOnNonDesktopLff,
...
BASE_FEATURE(kAndroidAppearanceSettings, base::FEATURE_DISABLED_BY_DEFAULT); // Vivaldi
...
BASE_FEATURE(kAndroidSettingsContainment, base::FEATURE_DISABLED_BY_DEFAULT); // Vivaldi
...
BASE_FEATURE(kCompositorViewHolderObscuring, base::FEATURE_DISABLED_BY_DEFAULT);
...
#if !defined(OEM_AUTOMOTIVE_BUILD) // Vivaldi
BASE_FEATURE(kDesktopUAOnConnectedDisplay, base::FEATURE_ENABLED_BY_DEFAULT); // Vivaldi
#else // Vivladi
...
BASE_FEATURE(kEscCancelDrag, base::FEATURE_DISABLED_BY_DEFAULT); // Vivaldi
...
BASE_FEATURE(kTabStripCloseRefactorAndroid, base::FEATURE_DISABLED_BY_DEFAULT); // Vivaldi
...
BASE_FEATURE(kTopControlsRefactor, base::FEATURE_DISABLED_BY_DEFAULT); // Vivaldi
BASE_FEATURE(kTopControlsRefactorV2, base::FEATURE_DISABLED_BY_DEFAULT); // Vivaldi
