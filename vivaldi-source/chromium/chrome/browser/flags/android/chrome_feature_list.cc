...
BASE_FEATURE(kBottomSheetAsBrowserControls, base::FEATURE_DISABLED_BY_DEFAULT); // Vivaldi VAB-13253
...
BASE_FEATURE(kSettingsMultiColumn, base::FEATURE_DISABLED_BY_DEFAULT); // Vivaldi
