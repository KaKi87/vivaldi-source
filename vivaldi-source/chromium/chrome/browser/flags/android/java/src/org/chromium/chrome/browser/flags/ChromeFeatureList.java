...
public abstract class ChromeFeatureList {
    ...
    public static final CachedFlag sBottomSheetAsBrowserControls =
            // Vivaldi VAB-13253: stacker-based sheet covers our legacy bottom
            // toolbar; keep the legacy path.
            newCachedFlag(BOTTOM_SHEET_AS_BROWSER_CONTROLS, !BuildConfig.IS_VIVALDI);
    ...
    public static final CachedFlag sCctBlockTouchesDuringEnterAnimation =
            newCachedFlag(CCT_BLOCK_TOUCHES_DURING_ENTER_ANIMATION,
                    !BuildConfig.IS_OEM_MERCEDES_BUILD); // Vivaldi ref. AUTO-269
    ...
    public static final CachedFlag sEdgeToEdgeBottomChin =
            newCachedFlag(EDGE_TO_EDGE_BOTTOM_CHIN, /* defaultValue= */ false); // Vivaldi
    ...
    public static final CachedFlag sSettingsMultiColumn =
            newCachedFlag(SETTINGS_MULTI_COLUMN, /* defaultValue= */ false); // Vivaldi
    ...
    public static final MutableFlagWithSafeDefault sEscCancelDrag =
            newMutableFlagWithSafeDefault(ESC_CANCEL_DRAG, false); // Vivaldi
    ...
    */
    ...
    // Vivaldi
    public static final String VIVALDI_CINEMA_MODE = "VivaldiCinemaMode";

    public static final MutableFlagWithSafeDefault sVivaldiCinemaMode =
            newMutableFlagWithSafeDefault(VIVALDI_CINEMA_MODE, false);
    // End Vivaldi
}
