                ...
                new TabModelObserver() {
                    ...
                    public void tabClosureUndone(Tab tab) {
                        ...
                        if (mDialogController.isVisible()) {
                            ...
                            List<Tab> tabs = activity.getTabModelSelectorSupplier()
                                                     .get()
                    ...
                    public void willCloseTab(Tab tab, boolean didCloseAlone) {
                        ...
                        if (relatedTabs.size() == 1) {
                            ((TabGroupModelFilterImpl) mCurrentTabGroupModelFilterSupplier.get())
                                    .moveTabOutOfGroupInDirection(relatedTabs.get(0).getId(), true);
