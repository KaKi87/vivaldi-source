    ...
    public void buildMenuActionItems(ModelList itemList, Token tabGroupId) {
        ...
        itemList.add(
                new ListItemBuilder()
                        ...
                        .withStartIconRes(R.drawable.edit_group_color_24dp) // Vivaldi
                        .withIsIncognito(isIncognito)
                        .build());
        itemList.add(
                new ListItemBuilder()
        ...
        itemList.add(
                new ListItemBuilder()
                        ...
                        .withStartIconRes(R.drawable.close_tab_group) // Vivaldi
                        .withIsIncognito(isIncognito)
                        .build());
        if (mTabGroupSyncService != null && !isIncognito && !hasCollaborationData) {
            itemList.add(
                    new ListItemBuilder()
                            ...
                            .withStartIconRes(R.drawable.menu_recent_tabs_24dp) // Vivaldi
                            .build());
        }
    }
