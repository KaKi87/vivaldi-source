...
public class ToolbarManager
            ...
            LocationBarCoordinator locationBarCoordinator =
                    new LocationBarCoordinator(
                            ...
                            (url) ->
                                    ...
                                    // Vivaldi ref. VAB-9205 / VAB-10427
                                    && mBookmarkModelSupplier.get().isBookmarkModelLoaded()
                                            && !mBookmarkModelSupplier.get()
                                            .isInsideTrashFolder(mBookmarkModelSupplier.get()
                                                    .getMostRecentlyAddedUserBookmarkIdForUrl(url)),
                            () -> {
        ...
        mActivityTabTabObserver =
                new ActivityTabProvider.ActivityTabTabObserver(mActivityTabProvider) {
                    ...
                    public void onUrlUpdated(Tab tab) {
                        ...
                        // Vivaldi
                        toolbarLayout.updateShieldButtonState(tab.getUrl());
    ...
    private void refreshSelectedTab(Tab tab) {
        ...
        if (previousTab != tab || wasIncognitoBranded != isIncognitoBranded) {
            ...
            // Note(david@vivaldi.com): We might need to refocus the url bar.
            boolean isTablet = DeviceFormFactor.isNonMultiDisplayContextOnTablet(mActivity);
            if (VivaldiPreferences.getSharedPreferencesManager().readBoolean(
                        VivaldiPreferences.FOCUS_ADDRESS_BAR_ON_NEW_TAB, false) && isTablet) {
