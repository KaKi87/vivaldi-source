...
public class RecentTabsManager
    ...
    /** Vivaldi members */
    private @Nullable VivaldiRecentTabsManager mVivaldiRecentTabManager;
    ...
    public RecentTabsManager(
        ...
        // Vivaldi: Get the correct ModalDialogManager.
        ChromeActivity chromeActivity = (ChromeActivity) activity;
        ModalDialogManager dialogManager = chromeActivity.getModalDialogManagerSupplier().get();
        if (dialogManager == null)
            dialogManager = new ModalDialogManager(
    ...
    /** Vivaldi */
    public @Nullable VivaldiRecentTabsManager getVivaldiRecentTabsManager() {
