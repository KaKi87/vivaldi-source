...
import org.vivaldi.browser.customtabs.VivaldiCustomTabZoomHelper;
...
public class CustomTabActivityTabController implements PauseResumeWithNativeObserver, Destroyable {
    ...
    private void initializeTab(Tab tab, boolean isHiddenTab) {
        ...
        if (BuildConfig.IS_OEM_MERCEDES_BUILD) {
            ...
            assert customTabActivity != null && customTabActivity.getIntentDataProvider() != null;

            VivaldiCustomTabZoomHelper.applyInitialZoom(tab,
                    customTabActivity.getIntentDataProvider().getInitialZoomFactor());
        }
    }
