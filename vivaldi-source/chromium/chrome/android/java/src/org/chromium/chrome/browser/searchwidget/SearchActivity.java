...
public class SearchActivity extends AsyncInitializationActivity
    ...
    private void beginQuery() {
        ...
        if (ChromeApplicationImpl.isVivaldi() &&
                Objects.equals(getIntent().getAction(), Intent.ACTION_WEB_SEARCH)) {
            mSearchUiCoordinator.getLocationBarCoordinator().setUrlBarFocusable(false);
        }
    ...
    /* package */ ViewGroup createContentView() {
        ...
        contentView.setBackgroundColor(getColor(R.color.toolbar_background_primary_dark_with_tabs));
        return contentView;
    }
