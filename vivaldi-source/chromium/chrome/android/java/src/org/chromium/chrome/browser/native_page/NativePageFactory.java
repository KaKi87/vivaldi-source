...
public class NativePageFactory {
    ...
    @Nullable NativePage createNativePageForURL(
        ...
        if (ChromeApplicationImpl.isVivaldi() && tab != null)
            return createNativePageForURLVivaldi(url, candidatePage, tab, isIncognito, pdfInfo);
    ...
    public static class TabShim implements NativePageHost { // Vivaldi: public access
    ...
    private @Nullable NativePage createNativePageForURLVivaldi(
            String url,
            @Nullable NativePage candidatePage,
            Tab tab,
            boolean isIncognito,
        ...
        switch (NativePage.nativePageType(
                new GURL(url), candidatePage, isIncognito, false, pdfInfo != null)) {
            case NativePageType.NONE:
                return null;
            case NativePageType.CANDIDATE:
                page = candidatePage;
            ...
            case NativePageType.PDF:
                assumeNonNull(pdfInfo);
                if (mPdfFragmentViewTracker == null) {
                    mPdfFragmentViewTracker = new PdfFragmentViewTrackerImpl(
                            mTabModelSelector, (FragmentActivity) mActivity);
                }
                page = getBuilder().buildPdfPage(tab, url, pdfInfo, mPdfFragmentViewTracker);
                break;
