...
public class RootUiCoordinator
    ...
    /** Vivaldi **/
    protected @Nullable PanelManager mPanelManager;
    ...
    public boolean toggleGlic(boolean preventClose) {
        return false;
        //return toggleGlic(preventClose, GlicInvocationSource.UNSUPPORTED); Vivaldi
    }
    ...
    public void onPostInflationStartup() {
        ...
        // Vivaldi
        mPanelManager = new PanelManager(mActivity, mBottomSheetControllerSupplier.get(),
                ((ChromeActivity) mActivity).getSnackbarManager(), false, false);
    ...
    public void onFinishNativeInitialization() {
        ...
        if (DeviceInfo.isAutomotive()) {
            ...
            // Vivaldi
            if (!VivaldiUtils.isAutomotiveToolbarEnabled()) return;
