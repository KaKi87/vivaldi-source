...
//import org.chromium.chrome.browser.glic.GlicActorLoginPermissionsFragment; Not needed in Vivaldi
//import org.chromium.chrome.browser.glic.GlicSettings; Not needed in Vivaldi
...
// Vivaldi
import org.vivaldi.browser.password_manager.settings.PasswordSettings;
...
public class SettingsNavigationImpl implements SettingsNavigation {
    ...
    public SettingsNavigationImpl() {} // Vivaldi
    ...
    public void startSettings(
        ...
        switch (settingsFragment) {
            ...
            case SettingsFragment.PASSWORDS: // Vivaldi
                break;
        }
        startSettings(
    ...
    private static @Nullable Class<? extends Fragment> getFragmentClassFromEnum(
        ...
        switch (fragment) {
            ...
            case SettingsFragment.GLIC_PERMISSIONS:
                return GlicActorLoginPermissionsFragment.class; Not needed in Vivaldi */
            case SettingsFragment.GOOGLE_SERVICES:
