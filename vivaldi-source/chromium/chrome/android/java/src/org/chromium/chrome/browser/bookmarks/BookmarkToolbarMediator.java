...
class BookmarkToolbarMediator
    ...
    boolean onMenuIdClick(@IdRes int id) {
        ...
        if (id == R.id.create_new_folder_menu_id) {
            ...
            if (ChromeApplicationImpl.isVivaldi()) {
                VivaldiBookmarkAddEditFolderActivity.startEditFolderActivity(mContext, mCurrentFolder);
                return true;
            } // End Vivaldi
            ...
            if (ChromeApplicationImpl.isVivaldi()) {
                if (PanelUtils.isPanelOpen(mTabbedActivity)) {
                    ...
                    return true;
                } else if (mTabbedActivity != null
                        && mTabbedActivity.getBottomSheetController() != null
                        && mTabbedActivity.getBottomSheetController().getCurrentSheetContent()
                        != null) {
                    mTabbedActivity.getBottomSheetController().hideContent(
                            mTabbedActivity.getBottomSheetController().getCurrentSheetContent(),
                            true);
                    return true;
                }
            ...
            List<BookmarkId> list = mSelectionDelegate.getSelectedItemsAsList();
            if (ChromeApplicationImpl.isVivaldi()) {
                VivaldiBookmarkFolderSelectActivity.startFolderSelectActivity(
