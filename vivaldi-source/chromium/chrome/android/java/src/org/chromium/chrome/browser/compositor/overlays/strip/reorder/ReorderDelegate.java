...
public class ReorderDelegate {
    ...
    // Vivaldi
    private VivaldiTabReorderStrategy mVivaldiStrategy;
    ...
    public boolean isReorderingTab() {
        return getInReorderMode()
                && ((mActiveStrategy == mSourceViewDragDropReorderStrategy
                        ...
                        || mActiveStrategy == mVivaldiStrategy);
    }
    ...
    public void initialize(
        ...
        // Vivaldi has it's own reorder strategy.
        mVivaldiStrategy =
                new VivaldiTabReorderStrategy(
                        this,
                        mStripUpdateDelegate,
                        mAnimationHost,
                        mScrollDelegate,
    ...
    /** Vivaldi - Forward the instanceOfStackStrip. */
    public void setIsInstanceOfStackStrip(boolean instanceOfStackStrip) {
        if (mVivaldiStrategy != null)
            mVivaldiStrategy.setIsInstanceOfStackStrip(instanceOfStackStrip);
    }
}
