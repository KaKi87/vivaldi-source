...
public class OverlayPanel extends OverlayPanelAnimation
     ...
     * needs to be taken. This should be overridden by child classes. TODO(mdjones): Get a better
     * name for this.
     */
     ...
     * showing due animation. Use {@link #isShowing} instead to determine if the panel is physically
     * visible.
     *
     ...
     * See {@link BrowserControlsState.update(Tab, tab, int current, boolean animate)}
     *
     ...
     * been recognized. See {@link GestureDetector.SimpleOnGestureListener#onShowPress()}.
     *
     * @param x The x coordinate in dp.
     * @param y The y coordinate in dp.
     */
