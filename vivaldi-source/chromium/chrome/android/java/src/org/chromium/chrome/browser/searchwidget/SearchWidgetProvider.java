...
public class SearchWidgetProvider extends AppWidgetProvider {
    ...
    /** Vivaldi */
    public static PendingIntent createVivaldiQrCodeScanIntent(Context context) {
        // Launch the SearchActivity.
        Intent searchIntent = new Intent(ACTION_VIVALDI_START_QR_CODE_SCAN);
        searchIntent.setClass(context, SearchActivity.class);
        searchIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        searchIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_DOCUMENT);
        searchIntent.putExtra(VivaldiIntentHandler.EXTRA_SCAN_QR_CODE, true);
