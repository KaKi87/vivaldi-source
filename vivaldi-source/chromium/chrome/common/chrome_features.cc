...
// Chrome versions.
BASE_FEATURE(kGlic,
#if !defined(VIVALDI_BUILD) // BUILDFLAG(IS_MAC) || BUILDFLAG(IS_WIN) || BUILDFLAG(IS_CHROMEOS)
             base::FEATURE_ENABLED_BY_DEFAULT
#else
             base::FEATURE_DISABLED_BY_DEFAULT  // Vivaldi keep disabled
#endif
...
BASE_FEATURE(kGlicBackgroundActuation, base::FEATURE_DISABLED_BY_DEFAULT);  // Vivaldi keep disabled

BASE_FEATURE(kGlicSupportLinks, base::FEATURE_DISABLED_BY_DEFAULT);  // Vivaldi keep disabled
