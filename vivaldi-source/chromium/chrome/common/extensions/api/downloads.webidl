...
dictionary DownloadOptions {
  ...
  // Vivaldi: override destination folder path
  DOMString path;
};
...
// Vivaldi addition. Insecure content download state. See InsecureContentStatus.
enum InsecureStatusType {
  "unknown",
  "safe",
  "validated",
  "warn",
...
dictionary DownloadItem {
  ...
  // Vivaldi addition. Current speed.
  required double currentSpeed;

  // Vivaldi addition. Insecure content state.
  InsecureStatusType mixedState;
};
