...
// production.
BASE_FEATURE(kAttachUnownedInnerWebContents, base::FEATURE_ENABLED_BY_DEFAULT); // Vivaldi
...
BASE_FEATURE(kAndroidOpenPdfInline, base::FEATURE_DISABLED_BY_DEFAULT); // Vivaldi Ref:VAB-11481
