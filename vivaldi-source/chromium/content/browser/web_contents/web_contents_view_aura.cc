...
// Helper to direct the tab drag to Vivaldi UI
...
void WebContentsViewAura::StartDragging(
  ...
  DragOperation result_op;
  {
    ...
    if (
        ...
        // fully deprecated.
    // NOTE(ondrej@vivaldi.com): VB-123201
...
void WebContentsViewAura::CompleteDrop(OnPerformingDropContext drop_context) {
  ...
  VivaldiEventHooks::HandleDragEnd(web_contents_, false,
                                   drop_context.transformed_pt->x(),
                                   drop_context.transformed_pt->y());
}
