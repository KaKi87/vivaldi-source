...
class CONTENT_EXPORT RenderFrameHostImpl
 ...
 public:
  ...
  void VisibleTextSelectionChanged(const std::u16string& text) override;
 ...
 private:
  ...
  // Vivaldi additions. To minimize the amount of patch blocks here we list both
  // methods and fields.
 public:
  const mojo::AssociatedRemote<vivaldi::mojom::VivaldiFrameService>&
  GetVivaldiFrameService();
  void SetSupportsDraggableRegions(bool) override;

 private:
  mojo::AssociatedRemote<vivaldi::mojom::VivaldiFrameService>
      vivaldi_frame_service_;
  // End Vivaldi
