...
void UpdateNavigationRequestClientUaHeadersImpl(
    ...
    const std::optional<GURL>& request_url = std::nullopt) { // Vivaldi
  std::optional<blink::UserAgentMetadata> ua_metadata;
  bool disable_due_to_custom_ua = false;
  if (is_ua_override_on || (vivaldi::IsVivaldiRunning() &&
    ...
    // hints, disable them.
    disable_due_to_custom_ua = is_ua_override_on && !ua_metadata.has_value();
  }
...
void UpdateNavigationRequestClientUaHeaders(
  ...
  UpdateNavigationRequestClientUaHeadersImpl(
      ...
      /*ftn_for_devtools_override=*/frame_tree_node, request_url); // Vivaldi
}
namespace {
...
void AddRequestClientHintsHeaders(
  ...
  UpdateNavigationRequestClientUaHeadersImpl(
      ...
      ftn_for_devtools_override, request_url); // Vivaldi
...
void AddNavigationRequestClientHintsHeaders(
  ...
  AddRequestClientHintsHeaders(
      ...
      container_policy, /*ftn_for_devtools_override=*/frame_tree_node, request_url);
}
