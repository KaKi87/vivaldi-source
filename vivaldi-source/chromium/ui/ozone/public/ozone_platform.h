...
class COMPONENT_EXPORT(OZONE) OzonePlatform {
 public:
  ...
  // Vivaldi
  // Wayland-specific: Returns the AcceleratedWidget for the window under
  // pointer, or gfx::kNullAcceleratedWidget if pointer is outside of windows.
  virtual gfx::AcceleratedWidget GetVivaldiDragEndWidget();
