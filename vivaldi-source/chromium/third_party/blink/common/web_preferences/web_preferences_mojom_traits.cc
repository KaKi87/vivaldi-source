...
bool StructTraits<blink::mojom::WebPreferencesDataView,
  ...
  out->has_vivaldi_follower_tab =
      data.has_vivaldi_follower_tab();
  out->vivaldi_show_context_menu_on_double_click =
      data.vivaldi_show_context_menu_on_double_click();
  // End Vivaldi
