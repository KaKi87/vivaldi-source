...
#import "ios/ui/ntp/legacy/legacy_speed_dial_container_view.h"
...
#import "ios/ui/ntp/legacy/cells/legacy_speed_dial_folder_list_cell.h"
#import "ios/ui/ntp/legacy/cells/legacy_speed_dial_folder_regular_cell.h"
#import "ios/ui/ntp/legacy/cells/legacy_speed_dial_icon_cell.h"
#import "ios/ui/ntp/legacy/cells/legacy_speed_dial_list_cell.h"
#import "ios/ui/ntp/legacy/cells/legacy_speed_dial_regular_cell.h"
#import "ios/ui/ntp/legacy/cells/legacy_speed_dial_small_cell.h"
#import "ios/ui/ntp/vivaldi_ntp_constants.h"
#import "ios/ui/ntp/vivaldi_start_page_add_group_view.h"
...
@interface VivaldiSpeedDialContainerView () <
    ...
    VivaldiStartPageAddGroupViewDelegate,
...
@property(weak, nonatomic) VivaldiStartPageAddGroupView* addGroupView;
...
- (void)setUpUI {
  ...
  // Add group view
  VivaldiStartPageAddGroupView* addGroupView =
      [VivaldiStartPageAddGroupView new];
...
#pragma mark - VivaldiStartPageAddGroupViewDelegate
  ...
  auto faviconLoadedBlock = ^(FaviconAttributes* attributes, bool cached) {
    ...
    switch (strongSelf.selectedLayout) {
      ...
      case VivaldiStartPageLayoutStyleMedium: {
        ...
        if (item.urlString &&
            [largeCell.itemUrlString isEqualToString:item.urlString]) {
      ...
      case VivaldiStartPageLayoutStyleSmall: {
        ...
        if (item.urlString &&
            [smallCell.itemUrlString isEqualToString:item.urlString]) {
...
- (void)setBottomContentInset:(CGFloat)inset {
  _collectionView.contentInset = UIEdgeInsetsMake(0, 0, inset, 0);
}
