...
const UIEdgeInsets titleLabelPadding = UIEdgeInsetsMake(0.f, 8.f, 8.f, 8.f);
}  // namespace
...
- (void)setUpUI {
  ...
  self.iconWidthConstraint = [iconView.widthAnchor
      constraintEqualToConstant:vSpeedDialFolderIconSizeMedium.width];
  self.iconHeightConstraint = [iconView.heightAnchor
  ...
  switch (style) {
    ...
    case VivaldiStartPageLayoutStyleMedium:
      ...
      self.iconHeightConstraint.constant =
          vSpeedDialFolderIconSizeMedium.height;
