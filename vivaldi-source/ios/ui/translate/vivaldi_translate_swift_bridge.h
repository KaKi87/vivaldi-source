...
#ifndef IOS_UI_TRANSLATE_VIVALDI_TRANSLATE_SWIFT_BRIDGE_H_
#define IOS_UI_TRANSLATE_VIVALDI_TRANSLATE_SWIFT_BRIDGE_H_
...
#endif /* IOS_UI_TRANSLATE_VIVALDI_TRANSLATE_SWIFT_BRIDGE_H_ */
