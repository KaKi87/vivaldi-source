...
#ifndef IOS_UI_SETTINGS_PAGEZOOM_VIVALDI_PAGEZOOM_SETTINGS_SWIFT_BRIDGE_H_
#define IOS_UI_SETTINGS_PAGEZOOM_VIVALDI_PAGEZOOM_SETTINGS_SWIFT_BRIDGE_H_
...
#endif /* IOS_UI_SETTINGS_PAGEZOOM_VIVALDI_PAGEZOOM_SETTINGS_SWIFT_BRIDGE_H_ \
        */
