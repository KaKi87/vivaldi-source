...
- (void)showErrorCellWithMessage:(NSString*)message
  ...
  [self.tableViewModel insertItem:[self errorCellItemWithMessage:message
                                                        itemType:itemType
                                                       textColor:color]
...
- (void)removeErrorCell:(NSInteger)section itemType:(NSInteger)itemType {
  if ([self hasErrorCell:section itemType:itemType]) {
    NSIndexPath* path = [self.tableViewModel indexPathForItemType:itemType
...
- (BOOL)hasErrorCell:(NSInteger)section itemType:(NSInteger)itemType {
  return [self.tableViewModel hasItemForItemType:itemType
                               sectionIdentifier:section];
}

- (void)reloadSection:(NSInteger)section {
  NSUInteger index = [self.tableViewModel sectionForSectionIdentifier:section];
