...
#ifndef IOS_UI_SETTINGS_GENERAL_VIVALDI_GENERAL_SETTINGS_SWIFT_BRIDGE_H_
#define IOS_UI_SETTINGS_GENERAL_VIVALDI_GENERAL_SETTINGS_SWIFT_BRIDGE_H_
...
#endif /* IOS_UI_SETTINGS_GENERAL_VIVALDI_GENERAL_SETTINGS_SWIFT_BRIDGE_H_ */
