...
+ (UIKeyCommand*)cr_openNewWindow {
  UIImage* image = CustomSymbolWithConfiguration(vMenuNewWindow, nil);
  return [self cr_commandWithInput:@"n"
...
+ (UIKeyCommand*)cr_showBookmarks {
  UIImage* image = CustomSymbolWithConfiguration(vMenuShowBookmarks, nil);
...
+ (UIKeyCommand*)cr_showReadingList {
  UIImage* image = CustomSymbolWithConfiguration(vMenuShowReadingList, nil);
  return [self cr_commandWithInput:@"r"
                     modifierFlags:AltCommand
