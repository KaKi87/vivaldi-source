...
- (void)anchorTop:(NSLayoutYAxisAnchor*)top
  ...
  if (top) {
    NSLayoutConstraint* topAnchor =
        [self.topAnchor constraintEqualToAnchor:top constant:padding.top];
...
- (void)fillSuperviewWithPadding:(UIEdgeInsets)padding {
  ...
  // Top anchor
  NSLayoutConstraint* topAnchor =
      [self.topAnchor constraintEqualToAnchor:superViewTopAnchor
                                     constant:padding.top];
  [constraints addObject:topAnchor];

  // Leading/Left anchor
  NSLayoutConstraint* leadingAnchor =
      [self.leadingAnchor constraintEqualToAnchor:superViewLeadingAnchor
                                         constant:padding.left];
  [constraints addObject:leadingAnchor];

  // Bottom anchor
  NSLayoutConstraint* bottomAnchor =
      [self.bottomAnchor constraintEqualToAnchor:superViewBottomAnchor
                                        constant:-padding.bottom];
  [constraints addObject:bottomAnchor];

  // Trailing/Right anchor
  NSLayoutConstraint* trailingAnchor =
      [self.trailingAnchor constraintEqualToAnchor:superViewTrailingAnchor
                                          constant:-padding.right];
  [constraints addObject:trailingAnchor];
...
- (void)matchToView:(UIView*)view {
  [self matchToView:view padding:UIEdgeInsetsZero];
}
