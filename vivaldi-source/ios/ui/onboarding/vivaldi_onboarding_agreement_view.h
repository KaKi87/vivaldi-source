...
@property(nonatomic, copy, nullable) void (^onTermsDidTap)
    (NSURL* _Nonnull url, NSString* _Nonnull title);
@property(nonatomic, copy, nullable) void (^onPrivacyPolicyDidTap)
    (NSURL* _Nonnull url, NSString* _Nonnull title);
