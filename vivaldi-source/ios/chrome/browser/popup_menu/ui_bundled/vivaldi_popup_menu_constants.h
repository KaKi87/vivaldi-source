...
#ifndef IOS_CHROME_BROWSER_POPUP_MENU_UI_BUNDLED_VIVALDI_POPUP_MENU_CONSTANTS_H_
#define IOS_CHROME_BROWSER_POPUP_MENU_UI_BUNDLED_VIVALDI_POPUP_MENU_CONSTANTS_H_
...
#endif  // IOS_CHROME_BROWSER_POPUP_MENU_UI_BUNDLED_VIVALDI_POPUP_MENU_CONSTANTS_H_
