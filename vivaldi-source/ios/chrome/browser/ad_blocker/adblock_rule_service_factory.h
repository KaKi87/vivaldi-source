...
#ifndef IOS_CHROME_BROWSER_AD_BLOCKER_ADBLOCK_RULE_SERVICE_FACTORY_H_
#define IOS_CHROME_BROWSER_AD_BLOCKER_ADBLOCK_RULE_SERVICE_FACTORY_H_
...
#endif  // IOS_CHROME_BROWSER_AD_BLOCKER_ADBLOCK_RULE_SERVICE_FACTORY_H_
