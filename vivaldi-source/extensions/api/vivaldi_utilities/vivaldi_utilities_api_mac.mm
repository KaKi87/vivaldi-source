...
bool UtilitiesGetSystemDateFormatFunction::ReadDateFormats(
  ...
  if (dateFormatstrings[@"1"]) {
    ...
    NSString* shortDateFormat =
        [NSDateFormatter dateFormatFromTemplate:shortDateTemplate
                                        options:0
                                         locale:locale];
  ...
  if (dateFormatstrings[@"4"]) {
    ...
    NSString* longDateFormat =
        [NSDateFormatter dateFormatFromTemplate:longDateTemplate
                                        options:0
                                         locale:locale];
  ...
  NSString* timeFormat = [NSDateFormatter dateFormatFromTemplate:timeTemplate
                                                         options:0
                                                          locale:locale];
