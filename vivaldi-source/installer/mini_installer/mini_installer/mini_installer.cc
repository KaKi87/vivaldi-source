...
#include "installer/mini_installer/mini_installer/mini_installer.h"
...
#include "installer/mini_installer/mini_installer/configuration.h"
#include "installer/mini_installer/mini_installer/decompress.h"
#include "installer/mini_installer/mini_installer/delete_with_retry.h"
#include "installer/mini_installer/mini_installer/enumerate_resources.h"
#include "installer/mini_installer/mini_installer/memory_range.h"
#include "installer/mini_installer/mini_installer/mini_file.h"
#include "installer/mini_installer/mini_installer/mini_installer_constants.h"
#include "installer/mini_installer/mini_installer/regkey.h"
#include "installer/mini_installer/mini_installer/write_to_disk.h"
...
ProcessExitResult GetSetupExePathForAppGuid(bool system_level,
  ...
  RegKey key;
  LONG result = OpenClientStateKey(root_key, KEY_QUERY_VALUE, &key);
...
ProcessExitResult GetPreviousSetupExePath(const Configuration& configuration,
  ...
  return GetSetupExePathForAppGuid(configuration.is_system_level(),
                                   configuration.previous_version(), path,
                                   size);
}
