...
#include "installer/mini_installer/util/copy_tree_work_item.h"
#include "installer/mini_installer/util/create_dir_work_item.h"
#include "installer/mini_installer/util/create_reg_key_work_item.h"
#include "installer/mini_installer/util/delete_reg_key_work_item.h"
#include "installer/mini_installer/util/delete_reg_value_work_item.h"
