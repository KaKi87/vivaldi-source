...
#include "installer/mini_installer/setup/setup_main.h"
...
#include "installer/mini_installer/setup/archive_patch_helper.h"
#include "installer/mini_installer/setup/brand_behaviors.h"
#include "installer/mini_installer/setup/configure_app_container_sandbox.h"
#include "installer/mini_installer/setup/downgrade_cleanup.h"
#include "installer/mini_installer/setup/install.h"
#include "installer/mini_installer/setup/install_params.h"
#include "installer/mini_installer/setup/install_worker.h"
#include "installer/mini_installer/setup/installer_state.h"
#include "installer/mini_installer/setup/launch_chrome.h"
#include "installer/mini_installer/setup/modify_params.h"
#include "installer/mini_installer/setup/scoped_thread_pool.h"
#include "installer/mini_installer/setup/setup_constants.h"
#include "installer/mini_installer/setup/setup_install_details.h"
#include "installer/mini_installer/setup/setup_singleton.h"
#include "installer/mini_installer/setup/setup_util.h"
#include "installer/mini_installer/setup/uninstall.h"
#include "installer/mini_installer/setup/unpack_archive.h"
#include "installer/mini_installer/util/app_command.h"
#include "installer/mini_installer/util/conditional_work_item.h"
#include "installer/mini_installer/util/delete_after_reboot_helper.h"
#include "installer/mini_installer/util/delete_old_versions.h"
#include "installer/mini_installer/util/delete_tree_work_item.h"
...
#include "installer/mini_installer/util/install_service_work_item.h"
...
#include "installer/mini_installer/util/self_cleaning_temp_dir.h"
    ...
    *exit_code = InstallUtil::GetInstallReturnCode(status);
    if (*exit_code) {
      ...
      installer_state->WriteInstallerResult(
          status, IDS_VIVALDI_SETUP_PATCH_FAILED_BASE, nullptr);
    }
  ...
  if (!installer_version.get()) {
    ...
    if (proceed_with_installation) {
      ...
      InstallParams install_params = {
          ...
          temp_path.path(), *installer_version,   *src_size_kb};
...
int SetupMain(HINSTANCE instance) {
  ...
  if (!vivaldi::PrepareSetupConfig(instance))
    return installer::INSTALL_FAILED;
