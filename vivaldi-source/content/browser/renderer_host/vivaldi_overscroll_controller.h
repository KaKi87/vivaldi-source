...
// This is a copy of content/browser/renderer_host/overscroll_controller. Look
// there if anything drifts apart.

#ifndef CONTENT_BROWSER_RENDERER_VIVALDI_HOST_OVERSCROLL_CONTROLLER_H_
#define CONTENT_BROWSER_RENDERER_VIVALDI_HOST_OVERSCROLL_CONTROLLER_H_
...
class CONTENT_EXPORT VivaldiOverscrollController {
 public:
  VivaldiOverscrollController();

  VivaldiOverscrollController(const VivaldiOverscrollController&) = delete;
  VivaldiOverscrollController& operator=(const VivaldiOverscrollController&) =
      delete;

  virtual ~VivaldiOverscrollController();
...
#endif  // CONTENT_BROWSER_RENDERER_VIVALDI_HOST_OVERSCROLL_CONTROLLER_H_
