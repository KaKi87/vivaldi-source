...
void ExternalProcessImporterHost::ShowChromeWarningDialog() {
  ...
  if (source_profile_.importer_type == user_data_importer::TYPE_CHROME ||
    ...
    importerLockString_id = IDS_CHROME_IMPORTER_LOCK_TEXT;
                 ...
                 user_data_importer::TYPE_OPERA_OPIUM ||
             source_profile_.importer_type ==
                 user_data_importer::TYPE_OPERA_OPIUM_BETA ||
             source_profile_.importer_type ==
                 user_data_importer::TYPE_OPERA_OPIUM_DEV) {
    importerLockString_id = IDS_OPIUM_IMPORTER_LOCK_TEXT;
  } else if (source_profile_.importer_type == user_data_importer::TYPE_YANDEX) {
    importerLockString_id = IDS_YANDEX_IMPORTER_LOCK_TEXT;
  } else if (source_profile_.importer_type == user_data_importer::TYPE_BRAVE) {
  ...
  } else if (source_profile_.importer_type == user_data_importer::TYPE_ARC) {
...
bool ExternalProcessImporterHost::CheckForChromeLock(
  ...
  if (source_profile.importer_type != user_data_importer::TYPE_CHROME &&
      source_profile.importer_type != user_data_importer::TYPE_YANDEX &&
      source_profile.importer_type != user_data_importer::TYPE_OPERA_OPIUM &&
      source_profile.importer_type !=
          user_data_importer::TYPE_OPERA_OPIUM_BETA &&
      source_profile.importer_type !=
          user_data_importer::TYPE_OPERA_OPIUM_DEV &&
      source_profile.importer_type != user_data_importer::TYPE_BRAVE &&
      source_profile.importer_type != user_data_importer::TYPE_EDGE_CHROMIUM &&
      source_profile.importer_type != user_data_importer::TYPE_VIVALDI)
    return true;
