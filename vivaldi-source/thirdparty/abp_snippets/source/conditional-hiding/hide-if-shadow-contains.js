 ...
 * a CSS selector if the text content of the element's shadow
 ...
 *   for it to be hidden.
 * @example
 * hide-if-shadow-contains ads nav => Hides any nav element whose shadow's
 * text content contains the word ads.
 *
 * @see {@link https://eyeo.atlassian.net/wiki/spaces/CV/pages/69972006/hide-if-shadow-contains} for internal documentation.
 * @see {@link https://developers.eyeo.com/snippets/conditional-hiding-snippets/hide-if-shadow-contains} for external documentation.
